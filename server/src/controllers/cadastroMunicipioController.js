    ...
    static async cadastraMunicipioParceiro(req, res) {
        ...
        try {
          ...
          var mailOptions = {
            ...
            html:`<h2>Parabéns!</h2><p>O cadastro do seu município foi realizado com sucesso. Agora você faz parte do Projeto Digital Nomads CE e o seu município está apto a receber os Nômades Digitais.</p><p>Abaixo você pode ver os dados informados durante o cadastro:</p><ul><li>Cidade: ${novoMunicipioParceiro.cidade}</li><li>Região: ${novoMunicipioParceiro.regiao}</li><li>Email: ${novoMunicipioParceiro.email_prefeitura}</li><li>Contato: ${novoMunicipioParceiro.contato_prefeitura}</li><li>Link: ${novoMunicipioParceiro.link_prefeitura}</li><li>História: ${novoMunicipioParceiro.historia_cidade}</li><li>Serviço de Wifi: ${novoMunicipioParceiro.wifi_service}</li><li>Wifi da cidade: ${novoMunicipioParceiro.wifi_cidade}</li><li>Serviço para estrangeiro: ${novoMunicipioParceiro.service_estrangeiro}</li><li>Serviço da cidade: ${novoMunicipioParceiro.service_cidade}</li><li>Serviço para empresário: ${novoMunicipioParceiro.service_empresario}</li><li>Serviço de segurança: ${novoMunicipioParceiro.service_seguranca}</li><li>Pontos turísticos: ${novoMunicipioParceiro.pontos_turisticos}</li><li>Espaços Culturais: ${novoMunicipioParceiro.espacos_culturais}</li><li>Espaços de lazer: ${novoMunicipioParceiro.espacos_lazer}</li><li>Tipo de turismo: ${novoMunicipioParceiro.tipo_turismo}</li><li>Rota: ${novoMunicipioParceiro.rota}</li><li>Qual rota: ${novoMunicipioParceiro.qual_rota}</li></ul><p>Em breve esses dados acima informados poderão ser conferidos no site do projeto, na aba <strong>Escolha sua nova parada</strong>.</p><p>Agradecemos a participação do seu município nesse mais novo projeto e contamos com a sua colaboração para tornar o Ceará um polo para os Nômades Digitais</p><p>Para maiores duvidas ou esclarecimentos entre em contato conosco pelo e-mail: <a>digital.nomads@sedet.ce.gov.br</a> ou pelo telefone (85) 3108.1039.</p><p>Atenciosamente,</p><p>Equipe Digital Nomads CE.</p>`
